...
const FAQ_ITEMS = [
  ...
  {q:"¿Qué es una seña y cómo funciona?", a:"Un adelanto que el alumno paga para reservar una clase puntual. Se activa por alumno desde su ficha (pestaña «Ficha»). Si cancela con el aviso mínimo que definas en la política de cancelación, se le devuelve; si no, la retenés."},
